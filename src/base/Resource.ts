...
export abstract class Resource {
   ...
   * limited set of trading partners. This inherently limits the usefulness of 
   * the data in the long term. However, the existing health eco-system is highly 
   * fractured, and not yet ready to define, collect, and exchange data in a 
   * generally computable sense. Wherever possible, implementers and/or specification 
   * writers should avoid using this element. Often, when used, the URL is a reference 
   * to an implementation guide that defines these special rules as part of it's 
   ...
   * the language of other presentations generated from the data in the resource. 
   * Not all the content has to be in the base language. The Resource.language should 
   * not be assumed to apply to the narrative automatically. If a language is specified, 
