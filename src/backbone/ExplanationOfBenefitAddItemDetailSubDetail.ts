 ...
 */
export class ExplanationOfBenefitAddItemDetailSubDetail extends BackboneElement implements fhir.ExplanationOfBenefitAddItemDetailSubDetail {
  /**
  ...
  /**
   * Constructor for ExplanationOfBenefitAddItemDetailSubDetail
   */
