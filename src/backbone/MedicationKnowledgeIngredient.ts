 ...
 */
export class MedicationKnowledgeIngredient extends BackboneElement implements fhir.MedicationKnowledgeIngredient {
  /**
  ...
  /**
   * Constructor for MedicationKnowledgeIngredient
   */
