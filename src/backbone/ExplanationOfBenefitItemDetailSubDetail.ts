 ...
 */
export class ExplanationOfBenefitItemDetailSubDetail extends BackboneElement implements fhir.ExplanationOfBenefitItemDetailSubDetail {
  /**
  ...
  /**
   * Constructor for ExplanationOfBenefitItemDetailSubDetail
   */
