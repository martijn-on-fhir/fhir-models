 ...
 */
export class ExplanationOfBenefitAddItem extends BackboneElement implements fhir.ExplanationOfBenefitAddItem {
  /**
  ...
  /**
   * Constructor for ExplanationOfBenefitAddItem
   */
