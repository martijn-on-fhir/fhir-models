 ...
 */
export class MedicinalProductIngredientSpecifiedSubstanceStrength extends BackboneElement implements fhir.MedicinalProductIngredientSpecifiedSubstanceStrength {
  /**
