 ...
 */
export class ClaimResponseAddItemDetailSubDetail extends BackboneElement implements fhir.ClaimResponseAddItemDetailSubDetail {
  /**
  ...
  /**
   * Constructor for ClaimResponseAddItemDetailSubDetail
   */
