 ...
 */
export class ExplanationOfBenefitPayment extends BackboneElement implements fhir.ExplanationOfBenefitPayment {
  /**
  ...
  /**
   * Constructor for ExplanationOfBenefitPayment
   */
