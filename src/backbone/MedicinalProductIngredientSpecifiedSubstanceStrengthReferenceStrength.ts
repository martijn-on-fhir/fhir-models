 ...
 */
export class MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength extends BackboneElement implements fhir.MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength {
  /**
