 ...
 */
export class SubstancePolymerRepeatRepeatUnitStructuralRepresentation extends BackboneElement implements fhir.SubstancePolymerRepeatRepeatUnitStructuralRepresentation {
  /**
   * Todo.
   */
  @IsOptional()
