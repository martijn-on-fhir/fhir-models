...
export class RiskEvidenceSynthesis extends DomainResource implements fhir.RiskEvidenceSynthesis {
  ...
  /**
   * A copyright statement relating to the risk evidence synthesis and/or its contents. Copyright statements are generally le
   */
  @IsOptional()
  @IsString()
  copyright?: string;
  ...
  /**
   * This description can be used to capture details such as why the risk evidence synthesis was built, comments about misuse
   */
  @IsOptional()
  @IsString()
  description?: string;
  ...
  /**
   * The effective period for a risk evidence synthesis  determines when the content is applicable for usage and is independe
   */
  @IsOptional()
  @ValidateNested()
  @Type(() => Period)
  ...
  /**
   * It may be possible for the risk evidence synthesis to be used in jurisdictions other than those for which it was origina
   */
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
  ...
  /**
   * Usually an organization but may be an individual. The publisher (or steward) of the risk evidence synthesis is the organ
   */
  @IsOptional()
  @IsString()
  publisher?: string;
  ...
  /**
   * Constructor for RiskEvidenceSynthesis
   */
