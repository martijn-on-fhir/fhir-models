...
exports.ClaimItemDetail = void 0;
require("reflect-metadata");
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const BackboneElement_1 = require("../base/BackboneElement");
const ClaimItemDetailSubDetail_1 = require("./ClaimItemDetailSubDetail");
...
class ClaimItemDetail extends BackboneElement_1.BackboneElement {
    constructor(source = {}) {
        super(source);
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => ClaimItemDetailSubDetail_1.ClaimItemDetailSubDetail),
    __metadata("design:type", Array)
...
//# sourceMappingURL=ClaimItemDetail.js.map