...
exports.CoverageCostToBeneficiary = void 0;
...
const CoverageCostToBeneficiaryException_1 = require("./CoverageCostToBeneficiaryException");
const Money_1 = require("../elements/Money");
const Quantity_1 = require("../elements/Quantity");
class CoverageCostToBeneficiary extends BackboneElement_1.BackboneElement {
    constructor(source = {}) {
        super(source);
    }
}
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => CoverageCostToBeneficiaryException_1.CoverageCostToBeneficiaryException),
...
//# sourceMappingURL=CoverageCostToBeneficiary.js.map